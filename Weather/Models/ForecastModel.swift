...
struct Forecast: Identifiable {
    ...
    var icon: String {
        ...
        switch weather {
        case .clear:
            // Clear sky: use sun variant for day, moon variant for night
            return isDay ? "Sun cloud mid rain" : "Moon cloud fast wind"
        case .cloudy:
            // Cloudy: use appropriate day/night variant
            return isDay ? "Sun cloud mid rain" : "Moon cloud mid rain"
        case .rainy:
            // Rain: use appropriate day/night variant
            return isDay ? "Sun cloud mid rain" : "Moon cloud mid rain"
        case .stormy:
            // Storm: use angled rain for day, regular rain for night
            return isDay ? "Sun cloud angled rain" : "Moon cloud mid rain"
        case .sunny:
            // Sunny: use sun variant
            return "Sun cloud mid rain"
        case .tornado:
            return "Tornado"
        case .windy:
            // Windy: use fast wind for night, sun cloud for day
            return isDay ? "Sun cloud mid rain" : "Moon cloud fast wind"
        }
    }
}
